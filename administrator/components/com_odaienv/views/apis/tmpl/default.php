...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_odaienv&task=vms.saveOrderAjax&tmpl=component';
...
<form action="index.php?option=com_odaienv&view=api" method="post" name="adminForm" id="adminForm">
...
<?php
  ...
  foreach ($this->items as $i => $item) :
    			...
    			if (JRequest::getVar('function', null)) {
 				...
 				$link = JRoute::_( 'index.php?option=com_odaienv&view=vm&task=vm.edit&id='. $item->id ); 	
					...
					<div class="pull-left">
						...
						<div class="pull-left">
							<?php
								...
								JHtml::_('dropdown.edit', $item->id, 'vm.');
																JHtml::_('dropdown.divider');
								if ($item->state) :
									JHtml::_('dropdown.unpublish', 'cb' . $i, 'vms.');
								else :
									JHtml::_('dropdown.publish', 'cb' . $i, 'vms.');
								endif;									
								JHtml::_('dropdown.divider');

								if ($archived) :
									JHtml::_('dropdown.unarchive', 'cb' . $i, 'vms.');
								else :
									JHtml::_('dropdown.archive', 'cb' . $i, 'vms.');
								endif;
								
								if ($trashed) :
									JHtml::_('dropdown.untrash', 'cb' . $i, 'vms.');
								else :
									JHtml::_('dropdown.trash', 'cb' . $i, 'vms.');
								endif;								
