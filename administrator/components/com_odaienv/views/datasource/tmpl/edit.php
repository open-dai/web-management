...
JToolBarHelper::title(   JText::_( 'COM_ODAIENV_DATASOURCE' ).': <small><small>[ ' . $text.' ]</small></small>' );
JToolBarHelper::apply('datasource.apply');
JToolBarHelper::save('datasource.save');
if (!$edit) {
	JToolBarHelper::cancel('datasource.cancel');
} else {
	// for existing items the button is renamed `close`
	JToolBarHelper::cancel( 'datasource.cancel', 'Close' );
}
...
{
	if (task == 'datasource.cancel' || document.formvalidator.isValid(document.id('adminForm'))) {
		...
		<input type="hidden" name="view" value="datasource" />
