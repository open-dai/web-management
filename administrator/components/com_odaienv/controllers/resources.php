 ...
 * @subpackage  Odaienv
 */
class OdaienvControllerResources extends JControllerAdmin
{
	/**
	 * Constructor.
	 *
	 ...
	 *
	 * @return  OdaienvControllerResources
	 * @see     JController
	 */
...
//		$context = "$this->option.edit.task";
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Resource', $prefix = 'OdaienvModel', $config = array('ignore_request' => true))
	{
